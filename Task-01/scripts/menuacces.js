...
function CursorEstado() {
    ...
    let Ruta = "url('./Task-01/img/cursor/cursoracces.png'), auto";
...
let tamFuenteParrafos = parseFloat(localStorage.getItem("FuenteActualParrafosIngles3Task01")) || 1.3;
let tamFuenteSubtitulos = parseFloat(localStorage.getItem("FuenteActualSubtitulosIngles3Task01")) || 1.5;
// let tamFuentePleca = parseFloat(localStorage.getItem("FuenteActualPleca")) || 1;
let tamFuenteSubth3 = parseFloat(localStorage.getItem("FuenteActualSubtH3Ingles3Task01")) || 1.5;
let tamFuenteUl = parseFloat(localStorage.getItem("FuenteActualUlIngles3Task01")) || 1.3;
let tamFuenteOl = parseFloat(localStorage.getItem("FuenteActualOlIngles3Task01")) || 1.3;
...
btnAumentarFuente.addEventListener('click', function () {
    ...
    localStorage.setItem("FuenteActualSubtH3Ingles3Task01", tamFuenteSubth3.toString());
    localStorage.setItem("FuenteActualParrafosIngles3Task01", tamFuenteParrafos.toString());
    localStorage.setItem("FuenteActualUlIngles3Task01", tamFuenteUl.toString());
    localStorage.setItem("FuenteActualOlIngles3Task01", tamFuenteOl.toString());
    localStorage.setItem("FuenteActualSubtitulosIngles3Task01", tamFuenteSubtitulos.toString());
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let tamFuenteOl = parseFloat(localStorage.getItem("FuenteActualOlIngles3Task01")) || 1.3;
    let tamFuenteSubtitulos = parseFloat(localStorage.getItem("FuenteActualSubtitulosIngles3Task01")) || 1.5;
    let tamFuenteSubtitulosh3 = parseFloat(localStorage.getItem("FuenteActualSubtH3Ingles3Task01")) || 1.5;
