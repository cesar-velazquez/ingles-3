...
/******************************* OPA16  - TOPIC 2.2 ****************************/
    ...
    $(document).on('click', '#check-e-11-1', function(e) {
        ...
        for (var i = 1; i <= RespuestasEscribir11.length; i++) {
            ...
            if(correcto){             
                $("#" + recurso + " #escribir-1-1-" + i).siblings(".contselopc").html(text +' <i class="result fa-solid fa-check"></i><span class="respmens sr-only">Correct!</span>');
                $("#" + recurso + " #escribir-1-1-" + i).siblings(".contselopc").addClass("correcto");
            }
            else{
              $("#" + recurso + " #escribir-1-1-" + i).siblings(".contselopc").html(text +' <i class="result fa-solid fa-xmark"></i><span class="respmens sr-only">Incorrect!</span>');
        ...
        if (malEscribir11==0){
            ...
            if (vecesEscribir11<4){
                ...
                for (a=1; a<=RespuestasSelectTextos11.length; a++ ){
                    $("." + recurso + " #escribir-1-1-" + a).siblings(".contselopc").html(RespuestasSelectTextos11[a-1] +' <i class="result fa-solid fa-check"></i><span class="respmens sr-only">Correct!</span>');
...
/************ OPA17  - TOPIC 2.2****************************/
    ...
    */
    ...
    var ImgRespuestasSeleccionar112 = [ 1, 3, 4, 3, 2];
    var resTex112 = ["there was", "there were", "there weren't", "there were", "there wasn’t"];
    ...
    */
    ...
    $(document).on('click', '#try-s-22-2', function(e) {  
        ...
        $("#try-s-22-2").attr("disabled","disabled");
        $("#try-s-22-2").removeClass("btn-descarga");
        $(".seleccionar-2-2 .retroalimentacion1").html("");          
    });
