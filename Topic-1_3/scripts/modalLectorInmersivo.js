                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        ...
                        <ul class="parrafo ml-4">
                            ...
                            <li><i lang="en">Activity </i> OPA08: Alt + 1</li>                            
                            <li><i lang="en">Activity </i> OPA09: Alt + 2</li>                            
                            <li><i lang="en">Activity </i> OPA10: Alt + 3</li>                            
                        </ul>
                        ...
                        <ul class="parrafo ml-4">
                            ...
                            <li><i lang="en">Activity </i> OPA08: <i lang="en">Control </i> + <i lang="en">Option</i> + 1</li>                            
                            <li><i lang="en">Activity </i> OPA09: <i lang="en">Control </i> + <i lang="en">Option</i> + 2</li>                                                        
                            <li><i lang="en">Activity </i> OPA10: <i lang="en">Control </i> + <i lang="en">Option</i> + 3</li>                                                        
                        </ul>
                    </div>
                </div>
