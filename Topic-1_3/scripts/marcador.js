...
let marcaLink = localStorage.getItem("Marca Hipervínculos Topic-1_3");
...
link_resaltar.addEventListener('click', function () {
    if (!linkactivo) {
        ...
        iconLinkActive.style.display = "inline-flex";
        link_resaltar.classList.add("HerramientaActivada");
        localStorage.setItem("Marca Hipervínculos Topic-1_3", "activado");
    } else {
        linkactivo = false;
        ...
        localStorage.setItem("Marca Hipervínculos Topic-1_3", "desactivado");
    }
});
...
let marca = localStorage.getItem("Marca Cursor Topic-1_3");
...
btn_Cursor.addEventListener('click', function () {
    if (!cursor) {
        ...
        iconCursorActive.style.display = "inline-flex";
        btn_Cursor.classList.add("HerramientaActivada");
        localStorage.setItem("Marca Cursor Topic-1_3", "activado");
    } else {
        cursor = false;
        ...
        localStorage.setItem("Marca Cursor Topic-1_3", "desactivado");
    }
});
...
let marcaAzulLinea = localStorage.getItem("Marca Línea de Lectura Topic-1_3");
...
lineaLectura.addEventListener('click', function () {
    if (!lineaSelect) {
        ...
        iconLecturaActive.style.display = "inline-flex";
        lineaLectura.classList.add("HerramientaActivada");
        localStorage.setItem("Marca Línea de Lectura Topic-1_3", "activado");
    } else {
        lineaSelect = false;
        ...
        localStorage.setItem("Marca Línea de Lectura Topic-1_3", "desactivado");
    }
});
...
let marcaAzulFuente = localStorage.getItem("marcaAzulFuenteIngles3Topic1_3");
let contador = parseFloat(localStorage.getItem("contadorIngles3Topic1_3")) || 1;
...
let cont = parseFloat(localStorage.getItem("contadorIngles3Topic1_3")) || 1;
...
btn_FontSize.addEventListener('click', function () {
    ...
    if (cont === 2 || cont === 3) {
        ...
        iconFontSizeActive.style.display = "inline-flex";
        btn_FontSize.classList.add("HerramientaActivada");
        localStorage.setItem("marcaAzulFuenteIngles3Topic1_3", "activado");
        localStorage.setItem("contadorIngles3Topic1_3", cont.toString());
    }
        ...
        localStorage.setItem("marcaAzulFuenteIngles3Topic1_3", "desactivado");
        localStorage.setItem("contadorIngles3Topic1_3", cont.toString());
    }
});
