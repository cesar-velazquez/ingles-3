$(function() {
    ...
    function repetir(){
        ...
        for (var i = 1; i <= Respuestas_correctas.length; i++) {
            ...
            if(!($("#select-4-" + i).val() == Respuestas_correctas[i-1])){
                
                $("#select-4-" + i).removeClass("is-invalid");
                $("#select-4-" + i).attr('disabled', false);
        ...
        if (veces == 1){
            ...
            if (mal>0){
                ...
                if (intentos==4){
                    ...
                    $(".respuesta-correcta-select-4-1").val('2');
                    $(".respuesta-correcta-select-4-2").val('1');
                    $(".respuesta-correcta-select-4-3").val('2');
                    $(".respuesta-correcta-select-4-4").val('3');
                    $(".respuesta-correcta-select-4-5").val('1');

                    $(".evaluacion-1-4 .custom-select").removeClass("is-invalid");
                    $(".evaluacion-1-4 .custom-select").addClass("is-valid");
                    $(".evaluacion-1-4 .custom-select").attr('disabled', true);
    ...
    $(document).on('click', '#check-1-4', function(e) {
        ...
        for (var i = 1; i <= Respuestas_correctas.length; i++) {
            ...
            if(correcto){
                ...
                $("." + recurso + " #select-4-" + i).addClass("is-valid");
                $("." + recurso + " #select-4-" + i).attr('disabled', true);
                
                $(".mensaje-correct-incorrect-4-" + i).html("Statement " + i + " is correct!");

            }else{
                console.log("respuestas mal");
                $("." + recurso + " #select-4-" + i).addClass("is-invalid");
                $("." + recurso + " #select-4-" + i).attr('disabled', true);

                $(".mensaje-correct-incorrect-4-" + i).html("Statement " + i + " is incorrect!");
