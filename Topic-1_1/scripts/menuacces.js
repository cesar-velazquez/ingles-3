...
let estadoLinea = localStorage.getItem("Línea de Lectura Topic-1_1");
...
function showLine() {
    if (linea.classList.contains('active')) {
        ...
        localStorage.removeItem("Línea de Lectura Topic-1_1");
    } else {
        linea.classList.add('active');
        localStorage.setItem("Línea de Lectura Topic-1_1", "activado");
    }
}
...
let LinkAzul = localStorage.getItem("Hipervínculos Topic-1_1");
...
botonResaltar.addEventListener("click", function () {
    ...
    enlaces.forEach(enlace => {
        if (resaltar) {
            enlace.classList.add("resaltado");
            localStorage.setItem("Hipervínculos Topic-1_1", "activado");
        } else {
            enlace.classList.remove("resaltado");
            localStorage.setItem("Hipervínculos Topic-1_1", "desactivado");
        }
    });
});
...
function CursorEstado() {
    let estadoCursor = localStorage.getItem("cursor Topic-1_1");
    ...
    let cursorActivo = localStorage.getItem("Marca Cursor Topic-1_1");

    // let newRuta = "url('../img/cursor/cursoracces.png'), auto";
    let Ruta = "url('./Topic-1_1/img/cursor/cursoracces.png'), auto";
    ...
    localStorage.setItem("cursor Topic-1_1", document.body.style.cursor);
}
...
let tamFuenteParrafos = parseFloat(localStorage.getItem("FuenteActualParrafosIngles3Topic1_1")) || 1.3;
let tamFuenteSubtitulos = parseFloat(localStorage.getItem("FuenteActualSubtitulosIngles3Topic1_1")) || 1.5;
// let tamFuentePleca = parseFloat(localStorage.getItem("FuenteActualPleca")) || 1;
let tamFuenteSubth3 = parseFloat(localStorage.getItem("FuenteActualSubtH3Ingles3Topic1_1")) || 1.5;
let tamFuenteUl = parseFloat(localStorage.getItem("FuenteActualUlIngles3Topic1_1")) || 1.3;
let tamFuenteOl = parseFloat(localStorage.getItem("FuenteActualOlIngles3Topic1_1")) || 1.3;
...
btnAumentarFuente.addEventListener('click', function () {
    ...
    localStorage.setItem("FuenteActualSubtH3Ingles3Topic1_1", tamFuenteSubth3.toString());
    localStorage.setItem("FuenteActualParrafosIngles3Topic1_1", tamFuenteParrafos.toString());
    localStorage.setItem("FuenteActualUlIngles3Topic1_1", tamFuenteUl.toString());
    localStorage.setItem("FuenteActualOlIngles3Topic1_1", tamFuenteOl.toString());
    localStorage.setItem("FuenteActualSubtitulosIngles3Topic1_1", tamFuenteSubtitulos.toString());
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let tamFuenteOl = parseFloat(localStorage.getItem("FuenteActualOlIngles3Topic1_1")) || 1.3;
    let tamFuenteSubtitulos = parseFloat(localStorage.getItem("FuenteActualSubtitulosIngles3Topic1_1")) || 1.5;
    let tamFuenteSubtitulosh3 = parseFloat(localStorage.getItem("FuenteActualSubtH3Ingles3Topic1_1")) || 1.5;
