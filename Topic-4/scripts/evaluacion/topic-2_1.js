$(function() {
    ...
    var Respuestas_correctas = [ "afternoon", "weather", "people", "ufo", "windy", "strange lights", "fountain", "castle", "noise", "crowded", "railway" ];
    ...
    $(document).on('click', '#check-1-1', function(e) {
        ...
        for (var i = 1; i <= Respuestas_correctas.length; i++) {
            ...
            if($("#input-1-" + i).val().toLowerCase() == Respuestas_correctas[i-1] ){
                ...
                $(".mensaje-correct-incorrect-esc-" + i).html("word " + i + " is correct!");
                ...
                $(".mensaje-correct-incorrect-esc-" + i).html("word " + i + " is incorrect!");
