...
let marcaLink = localStorage.getItem("Marca Hipervínculos");
...
link_resaltar.addEventListener('click', function () {
    if (!linkactivo) {
        ...
        iconLinkActive.style.display = "inline-flex";
        link_resaltar.classList.add("HerramientaActivada");
        localStorage.setItem("Marca Hipervínculos", "activado");
    } else {
        linkactivo = false;
        ...
        localStorage.setItem("Marca Hipervínculos", "desactivado");
    }
});
...
// let marca = localStorage.getItem("Marca Cursor");
...
//         iconCursorActive.style.display = "inline-flex";
//         btn_Cursor.classList.add("HerramientaActivada");
//         localStorage.setItem("Marca Cursor", "activado");
//     } else {
//         cursor = false;
...
//         localStorage.setItem("Marca Cursor", "desactivado");
//     }
// });
...
let marcaAzulFuente = localStorage.getItem("marcaAzulFuenteIndexIngles3");
let contador = parseFloat(localStorage.getItem("contadorIndexIngles3")) || 1;
...
let cont = parseFloat(localStorage.getItem("contadorIndexIngles3")) || 1;
...
btn_FontSize.addEventListener('click', function () {
    ...
    if (cont === 2 || cont === 3) {
        ...
        iconFontSizeActive.style.display = "inline-flex";
        btn_FontSize.classList.add("HerramientaActivada");
        localStorage.setItem("marcaAzulFuenteIndexIngles3", "activado");
        localStorage.setItem("contadorIndexIngles3", cont.toString());
    }
        ...
        localStorage.setItem("marcaAzulFuenteIndexIngles3", "desactivado");
        localStorage.setItem("contadorIndexIngles3", cont.toString());
    }
});
...
let marcaAzulLinea = localStorage.getItem("Marca Línea de Lectura");
...
lineaLectura.addEventListener('click', function () {
    if (!lineaSelect) {
        ...
        iconLecturaActive.style.display = "inline-flex";
        lineaLectura.classList.add("HerramientaActivada");
        localStorage.setItem("Marca Línea de Lectura", "activado");
    } else {
        lineaSelect = false;
        ...
        localStorage.setItem("Marca Línea de Lectura", "desactivado");
    }
});
