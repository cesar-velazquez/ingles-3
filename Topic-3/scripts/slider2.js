            ...
            if (i < totalQuest) {
                ...
                for (var j = 0; j < Datos.preguntas[i].opciones.length; j++) {
                    $resp = $("<div>", {
                        ...
                        "numPreg": i
                    }).append("<input class='inputs-auto form-control' data-valor='"+i+"' placeholder='Write here...'/><p class='pastexto' ></p>");
                ...
                var $botones = $("<div>", {
                    "class": "botones" });
                var $boton1 = $("<button>", {
                    "class": "byc btn right control btn-right-"+i , "data-valor":i, "aria-hidden":true
                }).append("Next");
                var $boton2 = $("<button>", {
                    "class": "left btn control btn-left-"+i , "data-valor":i
                }).append("Check");
                        ...
                        contadorvacios++;
                            ...
                            $(contenedorPrin + " #item" + current + " input").each(function(i) {
                                ...
                                if (contestada == 1) {
                                    ...
                                    $(contenedorPrin + " #item" + numPreg + " .pastexto").html($(this).val()).append("<span class='sr-only'> correct! </span><i class='fa-solid fa-check' aria-hidden='true'></i>");
                                    conteoResp++;
                                } else {
                                    $(this).parent().addClass("inter-incorrecto");
                                    $(this).addClass("invisible");
                                    $(contenedorPrin + " #item" + numPreg + " .pastexto").html($(this).val()).append("<span class='sr-only'> incorrect! </span><i class='fa-solid fa-xmark' aria-hidden='true'></i>");
