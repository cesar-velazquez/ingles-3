    ...
    setTimeout(function() {
                    ...
                    $(contenedorPrin + " #item"+difer + current + " input").each(function(i) {
                        ...
                        respjunta+= $(this).val() + " ";
                            ...
                            //$(contenedorPrin + " #item"+difer + current + " input").each(function(i) {
                                ...
                                var contestada = 0;
                                if (contestada == 0) {
                                    //console.log("/"+arregloResp+"/ = /"+respjunta+"/");
                                    //text.trim()
        ...
        $(contenedorPrin + ' .right').click(function() {
            ...
            evaluaQuiz = function(difer) {
                ...
                console.log("conprin "+contenedorPrin);

                console.log($retroResp);

                //$(contenedorPrin + " .ultimo-c-item").append("Hola");
                $(contenedorPrin + " .ultimo-c-item").append($retroResp);

                var newStr = contenedorPrin.substring(1, contenedorPrin.length)

                
                //$(contenedorPrin + " .ultimo-c-item .botones").html('<button onClick="quizfinal(\'evaluacionfinal3\')" class="control activo">Intentar de nuevo</button>');
                $(contenedorPrin + " .ultimo-c-item .botones").html('<button onClick="quizfinal(\''+newStr+'\')" class="control activo">Intentar de nuevo</button>');
                ...
                $(contenedorPrin + '  .botones-modales').click(function() {
                    ...
                    $(contenedorPrin +" #item"+diferen + dataj).clone().appendTo($("#retroalimentacion-modal .modal-body"));
                });
            }
