...
let tamFuenteInput = parseFloat(localStorage.getItem("FuenteActualInput")) || 1.3;
...
btnAumentarFuente.addEventListener('click', function () {
    ...
    inputs.forEach(input => {
        input.style.fontSize = tamFuenteInput + 'rem';
    });
    ...
    localStorage.setItem("FuenteActualInput", tamFuenteInput.toString());
