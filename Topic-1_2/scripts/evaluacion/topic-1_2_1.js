$(function() {
    ...
    var Respuestas_correctas = [ 2, 1, 2, 1, 1, 1 ];
        ...
        if (veces == 1){
            ...
            if (mal>0){
                ...
                if (intentos==4){
                    ...
                    $(".respuesta-correcta-select-2").val('1');
                    $(".respuesta-correcta-select-3").val('2');
                    $(".respuesta-correcta-select-4").val('1');
                    $(".respuesta-correcta-select-5").val('1');
                    $(".respuesta-correcta-select-6").val('1');
                    
                    $(".custom-select").removeClass("is-invalid");
                    $(".custom-select").addClass("is-valid");
