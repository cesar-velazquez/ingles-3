...
let estadoLinea = localStorage.getItem("Línea de Lectura Topic-1_2");
...
function showLine() {
    if (linea.classList.contains('active')) {
        ...
        localStorage.removeItem("Línea de Lectura Topic-1_2");
    } else {
        linea.classList.add('active');
        localStorage.setItem("Línea de Lectura Topic-1_2", "activado");
    }
}
...
let LinkAzul = localStorage.getItem("Hipervínculos Topic-1_2");
...
// almacenar el local storage los hipervínculos
...
botonResaltar.addEventListener("click", function () {
    ...
    enlaces.forEach(enlace => {
        if (resaltar) {
            enlace.classList.add("resaltado");
            localStorage.setItem("Hipervínculos Topic-1_2", "activado");
        } else {
            enlace.classList.remove("resaltado");
            localStorage.setItem("Hipervínculos Topic-1_2", "desactivado");
        }
    });
});
...
function CursorEstado() {
    let estadoCursor = localStorage.getItem("cursor Topic-1_2");
    if (estadoCursor) {
        document.body.style.cursor = estadoCursor;
    }
    // let ubicacion = window.location.pathname;
    let cursorActivo = localStorage.getItem("Marca Cursor Topic-1_2");

    // let newRuta = "url('../img/cursor/cursoracces.png'), auto";
    let Ruta = "url('./Topic-1_2/img/cursor/cursoracces.png'), auto";
    ...
    localStorage.setItem("cursor Topic-1_2", document.body.style.cursor);
}
...
let tamFuenteParrafos = parseFloat(localStorage.getItem("FuenteActualParrafosIngles3Topic1_2")) || 1.3;
let tamFuenteSubtitulos = parseFloat(localStorage.getItem("FuenteActualSubtitulosIngles3Topic1_2")) || 1.5;
// let tamFuentePleca = parseFloat(localStorage.getItem("FuenteActualPleca")) || 1;
let tamFuenteSubth3 = parseFloat(localStorage.getItem("FuenteActualSubtH3Ingles3Topic1_2")) || 1.5;
let tamFuenteUl = parseFloat(localStorage.getItem("FuenteActualUlIngles3Topic1_2")) || 1.3;
let tamFuenteOl = parseFloat(localStorage.getItem("FuenteActualOlIngles3Topic1_2")) || 1.3;
...
btnAumentarFuente.addEventListener('click', function () {
    ...
    localStorage.setItem("FuenteActualSubtH3Ingles3Topic1_2", tamFuenteSubth3.toString());
    localStorage.setItem("FuenteActualParrafosIngles3Topic1_2", tamFuenteParrafos.toString());
    localStorage.setItem("FuenteActualUlIngles3Topic1_2", tamFuenteUl.toString());
    localStorage.setItem("FuenteActualOlIngles3Topic1_2", tamFuenteOl.toString());
    localStorage.setItem("FuenteActualSubtitulosIngles3Topic1_2", tamFuenteSubtitulos.toString());
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let tamFuenteOl = parseFloat(localStorage.getItem("FuenteActualOlIngles3Topic1_2")) || 1.3;
    let tamFuenteSubtitulos = parseFloat(localStorage.getItem("FuenteActualSubtitulosIngles3Topic1_2")) || 1.5;
    let tamFuenteSubtitulosh3 = parseFloat(localStorage.getItem("FuenteActualSubtH3Ingles3Topic1_2")) || 1.5;
